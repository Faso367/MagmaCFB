...
namespace Magma
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Сообщение об ошибке: {ex}\n"
                    + "\n   --------------   Внимание!!!   --------------\n" +
                    " Длина сообщения должна быть кратна двум. \n" +
                    " Сообщение должно быть введено в шестнадцатеричном формате.\n" +
                    " Шестнадцатеричный алфавит включает символы 0123456789abcdef");
            }
            catch(Exception ex)
            {
                Console.WriteLine($"Возникла непредвиденная ошибка: {ex}");
            }
